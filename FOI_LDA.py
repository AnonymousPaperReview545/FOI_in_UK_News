...
summary=df_dominant_topic['Keywords'].count()
...
df_mostrepresentative_new = sent_topics_sorteddf_mallet.merge(df, how='left', left_index=True, right_index=True)


df_mostrepresentative_new = df_mostrepresentative_new[['index','Index', 'Topic_Num', 'Topic_Perc_Contrib', 'Keywords', 
                                                       'Byline', 'Year', 'Newspaper']]
...
df_dominant_topics_contribution.columns = ['Num_Documents', 'Perc_Documents']
